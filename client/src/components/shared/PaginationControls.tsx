...
export function PaginationControls({ meta, onPageChange, href }: PaginationProps = { meta: { total: 0, page: 1, limit: 10, totalPages: 1 }, href: "" }) {
    ...
    const handlePageChange = (pageNumber: number) => {
        if (onPageChange) {
            ...
            navigateToPage(href, "page", pageNumber);
        }
    };
